...
- **돌진 공격**: 이동 + 충돌 판정 [`(OD_GA_Boss_DashAttack.cpp)`](Private/AbilitySystem/Abilities/Boss/OD_GA_Boss_DashAttack.cpp)
- **분노 모드**: 체력 구간별 강화 패턴 [`(OD_GA_Boss_Enrage.cpp)`](Private/AbilitySystem/Abilities/Boss/OD_GA_Boss_Enrage.cpp)
...
- **세션 관리**: 던전 내 몬스터 스폰/클리어 [(`ODDungeonSessionManager.cpp`)](Private/Manager/ODDungeonSessionManager.cpp)
 ...
 #### **던전 시스템(2안)**
- **인스턴스 풀 관리**: 객체 풀 패턴으로 던전 재사용 ([ODDungeonInstanceManager](cci:1://file:///c:/UnrealProject/StreamOD/OD/Source/OD/Private/Manager/ODDungeonInstanceManager.cpp:10:0-14:1))
  - 여러 던전 인스턴스 풀 관리 (`DungeonInstances[]`)
  - 빈 인스턴스 자동 할당 ([ConnectPartyToDunGeon](cci:1://file:///c:/UnrealProject/StreamOD/OD/Source/OD/Private/Manager/ODDungeonInstanceManager.cpp:67:0-96:1))
- **파티별 인스턴스**: 독립된 던전 공간 ([ODDungeonInstance](cci:1://file:///c:/UnrealProject/StreamOD/OD/Source/OD/Private/LevelInstance/ODDungeonInstance.cpp:12:0-23:1))
  - 하나의 파티 정보 소유 ([Party](cci:1://file:///c:/UnrealProject/StreamOD/OD/Source/OD/Private/LevelInstance/ODDungeonInstance.cpp:144:0-193:1))
  - 파티 진입/퇴장, 텔레포트 처리
- **몬스터 세션**: 던전 내 몬스터 관리 ([ODDungeonSessionManager](cci:1://file:///c:/UnrealProject/StreamOD/OD/Source/OD/Private/Manager/ODDungeonSessionManager.cpp:10:0-15:1))
  - 서버 권한 체크, 네트워크 복제
