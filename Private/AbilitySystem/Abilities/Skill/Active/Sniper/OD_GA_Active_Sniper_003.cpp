...
#include "AbilitySystem/Abilities/Skill/Active/Sniper/OD_GA_Active_Sniper_003.h"
...
UOD_GA_Active_Sniper_003::UOD_GA_Active_Sniper_003()
	:Super()
{
	AbilityTags.AddTag(OD_Active_Sniper_003);
	//SkillProjectileParms = FODSkillProjectileParms(3000.f);
}

bool UOD_GA_Active_Sniper_003::CanActivateAbility(const FGameplayAbilitySpecHandle Handle,
...
void UOD_GA_Active_Sniper_003::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	auto* MontageTask = UAbilityTask_PlayMontageAndWait::CreatePlayMontageAndWaitProxy(
		...
		AbilityMontage,
		MontageRate);
	MontageTask->OnCompleted.AddDynamic(this,&UOD_GA_Active_Sniper_003::OnMontageComplete);
	MontageTask->OnCancelled.AddDynamic(this,&UOD_GA_Active_Sniper_003::OnMontageCancelled);
	MontageTask->OnInterrupted.AddDynamic(this,&UOD_GA_Active_Sniper_003::OnMontageInterrupted);
	MontageTask->OnBlendOut.AddDynamic(this,&UOD_GA_Active_Sniper_003::OnMontageBlendOut);
	...
	if (K2_HasAuthority())
	{
		...
		auto* WaitHitTask = UAbilityTask_WaitGameplayEvent::WaitGameplayEvent(
			...
			false,
			true);
		WaitHitTask->EventReceived.AddDynamic(this, &UOD_GA_Active_Sniper_003::OnHitNotifyEvent);
	...
	auto* WaitRemoveTask = UAbilityTask_WaitGameplayEvent::WaitGameplayEvent(
		...
		true,
		true);
	WaitRemoveTask->EventReceived.AddDynamic(this, &UOD_GA_Active_Sniper_003::OnRemoveNotifyEvent);
...
void UOD_GA_Active_Sniper_003::EndAbility(const FGameplayAbilitySpecHandle Handle,
	const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo,
...
void UOD_GA_Active_Sniper_003::OnMontageComplete()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UOD_GA_Active_Sniper_003::OnMontageCancelled()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UOD_GA_Active_Sniper_003::OnMontageInterrupted()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UOD_GA_Active_Sniper_003::OnMontageBlendOut()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UOD_GA_Active_Sniper_003::OnHitNotifyEvent(const FGameplayEventData InData)
{
...
void UOD_GA_Active_Sniper_003::OnRemoveNotifyEvent(const FGameplayEventData InData)
{
